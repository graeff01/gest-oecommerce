...
export const DEFAULT_LAYOUT: WidgetLayoutItem[] = [
  ...
  { i: "chart-sales",     x: 0, y: 2, w: 8, h: 5, minW: 4, minH: 4, visible: true },
  { i: "customers",       x: 8, y: 2, w: 4, h: 5, minW: 2, minH: 3, visible: true },
  { i: "recent-orders",   x: 0, y: 7, w: 8, h: 5, minW: 4, minH: 4, visible: true },
  { i: "low-stock",       x: 8, y: 7, w: 4, h: 5, minW: 2, minH: 4, visible: true },
];
