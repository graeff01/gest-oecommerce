  ...
  return (
    <>
      ...
      <button
        ...
        className="fixed bottom-[calc(5.75rem+env(safe-area-inset-bottom))] right-4 z-30 inline-flex min-h-12 items-center gap-2 rounded-2xl bg-gradient-to-br from-primary to-primary-2 px-4 font-semibold text-primary-fg shadow-[0_18px_42px_-12px_rgb(var(--primary)/0.65)] transition hover:-translate-y-0.5 xl:hidden"
        title={title}
      >
